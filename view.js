...
(function(){
  var React, ref$, p, i, a, b, form, h1, div, main, span, br, h3, table, nav, tr, td, th, input, hr, meta, ul, ol, li, ruby, small, any, map, withProperties, divInline, h1Name, nbsp, CurrentId, shareButtons, Links, Nav, Taxonomy, MenuItem, DropDown, Result, Term, Translations, HASHOF, XREFLABELOF, XRefs, Star, Heteronym, decorateRuby, DefinitionList, Definition, CJKRADICALS, RadicalGlyph, RadicalTable, List, httpMap, http, canPlayMp3, canPlayOgg, canPlayOpus, untag, groupBy, Consonants, Vowels, Tones, re, C, V, keyMap, decodeLangPart, slice$ = [].slice, replace$ = ''.replace, join$ = [].join, split$ = ''.split;
  React = (typeof window != 'undefined' && window !== null ? window.React : void 8) || require('react');
  ref$ = React.DOM, p = ref$.p, i = ref$.i, a = ref$.a, b = ref$.b, form = ref$.form, h1 = ref$.h1, div = ref$.div, main = ref$.main, span = ref$.span, br = ref$.br, h3 = ref$.h3, table = ref$.table, nav = ref$.nav, tr = ref$.tr, td = ref$.td, th = ref$.th, input = ref$.input, hr = ref$.hr, meta = ref$.meta, ul = ref$.ul, ol = ref$.ol, li = ref$.li, ruby = ref$.ruby, small = ref$.small;
