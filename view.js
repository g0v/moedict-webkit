...
(function(){
  var ref$, p, i, a, h1, div, main, span, br, h3, table, tr, td, th, input, hr, meta, ol, li, ruby, small, any, map, withProperties, divInline, h1Name, nbsp, CurrentId, Result, Term, Translations, HASHOF, XREFLABELOF, XRefs, Heteronym, decorateRuby, DefinitionList, Definition, CJKRADICALS, RadicalGlyph, RadicalTable, List, httpMap, http, canPlayMp3, canPlayOgg, canPlayOpus, untag, groupBy, Consonants, Vowels, Tones, re, C, V, slice$ = [].slice, replace$ = ''.replace, join$ = [].join, split$ = ''.split;
  ...
  Term = React.createClass({
    render: function(){
      var ref$, LANG, H, title, english, heteronyms, radical, translation, nrsCount, sCount, py, xrefs, aStroke, $char, list, res$, i$, len$, props;
      ref$ = this.props, LANG = ref$.LANG, H = ref$.H, title = ref$.title, english = ref$.english, heteronyms = ref$.heteronyms, radical = ref$.radical, translation = ref$.translation, nrsCount = ref$.non_radical_stroke_count, sCount = ref$.stroke_count, py = ref$.pinyin, xrefs = ref$.xrefs;
