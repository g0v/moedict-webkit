  ...
  UserPref = React.createClass({
    render: function(){
      return div({}, h4({}, '偏好設定'), button({
        ...
        className: 'active'
      }, '直角共同顯示')), li({}, a({}, '只顯示注音符號', small({}, '（方言音）'))), li({}, a({}, '只顯示羅馬拼音')), li({
        className: 'divider',
        role: 'presentation'
      }), li({}, a({}, '置於條目名稱下方')), li({
        className: 'divider',
