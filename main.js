...
(function(){
  ...
  amisStemmer = function(word){
    var pre, suf, psw, index, prefix, suffix, pre_suffix, inIndex, i$, len$, ref$, w;
    prefix = ['papipaka', 'nipipaka', 'pasasi', 'papipa', 'nipipa', 'mipaka', 'saso', 'sasi', 'sapi', 'sapa', 'saka', 'piki', 'pasa', 'papi', 'pala', 'pako', 'paki', 'paka', 'nipi', 'nika', 'nani', 'nama', 'misa', 'miki', 'mala', 'kasa', 'hali', 'nai', 'sa', 'pi', 'pa', 'ni', 'na', 'mi', 'ma', 'ka', 'ci'];
    ...
    for (i$ = 0, len$ = pre_suffix.length; i$ < len$; ++i$) {
      ...
      if (word.startsWith(pre) && word.endsWith(suf)) {
    ...
    return dedupliction(word);
  };
  dedupliction = function(word){
    if (word.length >= 8) {
    ...
    if (word.length >= 10 && word.slice(2, 6) === word.slice(6, 10)) {
      return word.slice(0, 6);
    }
    if (word.length >= 6 && word.slice(0, 2) === word.slice(2, 4)) {
      return word.slice(2);
    }
    return word;
  };
