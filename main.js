...
(function(){
  ...
  zhuyin_lookup = function(term, cb){
    ...
    return GET("http://su-lip.magistry.fr/lookup/zhuyin/" + term, function(data){
      return cb(split$.call(data, '|'));
    });
  };
