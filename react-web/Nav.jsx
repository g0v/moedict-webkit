...
class DropDown extends React.Component { render() {
    return <ul className="dropdown-menu" role="navigation">{
        ...
        <MenuItem lang="a" href="##">國語辭典</MenuItem>,
        <Taxonomy lang="a" />,
        <MenuItem lang="a" href="#@">…部首表</MenuItem>,
        <MenuItem lang="t" href="#!">臺灣閩南語</MenuItem>,
        <Taxonomy lang="t" />,
        <MenuItem lang="t" href="#!=諺語">…諺語</MenuItem>,
        <MenuItem lang="h" href="#:">臺灣客家語</MenuItem>,
        <MenuItem lang="h" href="#:=諺語">…諺語</MenuItem>]
       }<MenuItem lang="c" href="#~">兩岸詞典</MenuItem>
        <Taxonomy lang="c" />
        <MenuItem lang="c" href="#~@">…部首表</MenuItem>
    </ul>
} }
